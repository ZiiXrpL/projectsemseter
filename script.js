    ...
    project.addEventListener('click', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href ="https://www.tiktok.com/@ziiivv22?_t=8rgGdOG6p2w&_r=1"
            }
        });
    })
})
...
formContact.addEventListener('submit', function (e) {
    ...
    const inputName = document.querySelector("fauzi");
    const inputEmail = document.querySelector("greeytchn@gmail.com");
